  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <div className="mt-3 h-5 w-48 rounded-md bg-zinc-200" />
      </div>
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_340px]">
        <div className="space-y-6">
          <div className="h-40 rounded-lg border border-zinc-200 bg-white p-5">
            <div className="h-5 w-40 rounded-md bg-zinc-200" />
            <div className="mt-4 h-20 rounded-md bg-zinc-200" />
          </div>
          <div className="h-80 rounded-lg border border-zinc-200 bg-white p-5">
            <div className="h-5 w-36 rounded-md bg-zinc-200" />
            <div className="mt-5 space-y-4">
              {[0, 1, 2].map((item) => (
                <div className="h-16 rounded-md bg-zinc-200" key={item} />
              ))}
            </div>
          </div>
        </div>
